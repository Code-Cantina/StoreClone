...
class SearchResultsCell: UICollectionViewCell {
    ...
    var appResult: Result! {
        didSet {
            ...
            ratingsLabel.text = "Rating: \(appResult.averageUserRating ?? 0)" //nil collesing.. unwrap and give value, or 0
    ...
    override init(frame: CGRect) {
        ...
        overallStackView.fillSuperview(padding: .init(top: 16, left: 16, bottom: 16, right: 16)) //using helper method
